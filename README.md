...
This repository is my collection of analytics projects using different tools like Python, Power BI, SQL, Tableau, and Excel.  
...
| E-Commerce Customer Satisfaction Analysis | Analyzes the root cause behind the customer satisfaction decline in certain timeline and build dashboard to maintain | [View Project](.ecommerce-customer-satisfaction) |
